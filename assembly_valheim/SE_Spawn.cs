...
public class SE_Spawn : StatusEffect
{
	...
	public override void UpdateStatusEffect(float dt)
	{
		...
		{
			this.m_spawned = true;
			Vector3 vector = this.m_character.transform.TransformVector(this.m_spawnOffset);
			GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(this.m_prefab, vector, Quaternion.identity);
