...
public class GlobalWind : MonoBehaviour
{
	...
	private void UpdateWind()
	{
		...
		if (this.m_cloth)
		{
			...
			this.m_cloth.externalAcceleration = vector * this.m_multiplier;
			this.m_cloth.randomAcceleration = vector * this.m_multiplier * this.m_clothRandomAccelerationFactor;
		}
	}
