...
public class Location : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		if (this.m_hasInterior)
		{
			...
			Vector3 vector = new Vector3(zoneCenter.x, base.transform.position.y + 5000f, zoneCenter.z);
			GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(this.m_interiorPrefab, vector, Quaternion.identity, base.transform);
