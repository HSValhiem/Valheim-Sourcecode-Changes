...
public class ConnectPanel : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (this.m_root.gameObject.activeInHierarchy)
		{
			...
			{
				foreach (GameObject gameObject in this.m_playerListElements)
				{
				...
				{
					GameObject gameObject2 = UnityEngine.Object.Instantiate<GameObject>(this.m_playerElement, this.m_playerList);
					(gameObject2.transform as RectTransform).anchoredPosition = new Vector2(0f, (float)i * -num8);
					this.m_playerListElements.Add(gameObject2);
				}
