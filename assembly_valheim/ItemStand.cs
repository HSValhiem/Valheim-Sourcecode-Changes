...
public class ItemStand : MonoBehaviour, Interactable, Hoverable
{
	...
	private void RPC_DestroyAttachment(long sender)
	{
		...
		this.m_nview.InvokeRPC(ZNetView.Everybody, "SetVisualItem", new object[] { "", 0, 0 });
	...
	private void DropItem()
	{
		...
		if (itemPrefab)
		{
			...
			GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(itemPrefab, this.m_dropSpawnPoint.position + vector, this.m_dropSpawnPoint.rotation * quaternion);
