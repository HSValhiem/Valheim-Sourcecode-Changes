...
public class MenuShipMovement : MonoBehaviour
{
	...
	private void Update()
	{
		...
		base.transform.rotation = Quaternion.Euler(Mathf.Sin(this.m_time * this.m_freq) * this.m_xAngle, 0f, Mathf.Sin(this.m_time * 1.53412342f * this.m_freq) * this.m_zAngle);
	}
